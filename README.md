...
- `Code/rover_main/rover_main.ino` – Controls sensors, motor logic, LoRa transmission, and hazard detection on the rover.  
- `Code/train_module_main/train_module_main.ino` – Receives and displays LoRa alerts, measures train speed, and transmits periodic updates to the rover.
